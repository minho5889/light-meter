...
LightMeterTests/
├── Logic/                  # 161 tests covering all pure logic
└── Formatting/
```
...
The codebase map. What each module does, how data flows from camera hardware through three layers to the screen, and how the 161-test suite covers it. Read this before you start porting anything.
