        ...
        ZStack {
            ...
            VStack(spacing: 20) {
                ...
                VStack(spacing: 24) {
                    ...
                    // Gauge and Wave Oscilloscope Area
                    HStack(spacing: 24) {
                    ...
                    VStack(alignment: .leading, spacing: 8) {
                        Text(viewModel.isCheckingFlicker ? viewModel.flickerSafetyLevel.uppercased() : "READY")
                            .font(.system(size: 14, weight: .bold, design: .rounded))
                            .foregroundColor(viewModel.isCheckingFlicker ? safetyColor : .white.opacity(0.6))
                            
                        Text(viewModel.isCheckingFlicker ? viewModel.flickerDescription : "Point your phone at a light source and tap the button below to start the health and safety checks.")
                    ...
                    Button(action: {
                        ...
                        HStack(spacing: 12) {
                            ...
                            Text(viewModel.isCheckingFlicker ? "Stop Check" : "Start Safety Check")
